...
const App = () => {
  const [chat, setChat] = useState([
    {
      system: { content: "Halo! Saya adalah agen AI multibahasa yang berjalan di Internet Computer. Saya akan merespons dalam bahasa Inggris, Jepang, dan Romaji. Silakan ajukan pertanyaan!" }
    }
  ]);
